...
class VueGeneral
    ...
    def cb_stats_admin
        txt= ctrl.get_admin_stats(builder.get_object("label_nomPark1").text)
    ...
    def cb_stats_com
        txt= ctrl.get_com_stats(builder.get_object("label_nomPark1").text)
    ...
    ##Preparation de la toolbar et menubar##
        ...
        ["SaveQuit", Gtk::Stock::SAVE, "_SaveQuit", nil, "Quitter en sauvegardant l'etat", quitterSauvegarder],
        ["Quit", Gtk::Stock::QUIT, "_Quitter", nil, "Quitte le programme sans sauvegarder", quitterSansSauvegarder],
